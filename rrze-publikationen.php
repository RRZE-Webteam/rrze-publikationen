...
class RRZE_Publikationen {
	...
	function rrze_publications_add_metabox_page() {
		add_meta_box(
			...
			array( 'Publications_Custom_Fields', 'rrze_publications_do_metabox'),
			'publication',
			'normal',
			'core'
		);
		add_meta_box(
			...
			__('Verwaltung', self::textdomain),
			array( 'Publications_Custom_Fields', 'rrze_publications_price_do_metabox'),
			'publication',
			'normal',
			'core'
		);
